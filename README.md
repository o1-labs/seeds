...
## Other static seed lists

`mainnet`:

- https://storage.googleapis.com/o1labs-mina-seed-lists/networks/mainnet.txt
- https://minataur.net/seeds

`devnet`:

- https://storage.googleapis.com/o1labs-mina-seed-lists/networks/devnet.txt
